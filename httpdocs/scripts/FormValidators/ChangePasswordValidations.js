$('#changePasswordForm').jqxValidator({
    ...
    animationDuration: 0,
    rules: [
        { input: '#earlierPassword', message: 'Current password Name is required!', action: 'keyup, blur', rule: 'required'
        },
...
//            }       
//        },
        { input: '#newPassword', message: 'New password Name is required!', action: 'keyup, blur', rule: 'required'
        },
